...
$stmt_users = $pdo->prepare("
    SELECT w.id, w.nom, w.prenom, w.type_piece, w.cni, w.telephone, w.email, w.code_voucher, w.mac_address, w.date_connexion,
...
<div class="card">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge badge-neutral" style="font-size:11px"><?php echo $type_lbl; ?></span></td>
    ...
    <div class="pagination">
        <?php if ($page > 1): ?>
            <a class="page-link" href="?page=<?php echo $page-1; ?>&<?php echo $qs; ?>">â† PrÃ©cÃ©dent</a>
        <?php endif; ?>
        <?php for ($i = max(1,$page-2); $i <= min($total_pages,$page+2); $i++): ?>
            <a class="page-link <?php echo $i==$page?'active':''; ?>" href="?page=<?php echo $i; ?>&<?php echo $qs; ?>"><?php echo $i; ?></a>
        <?php endfor; ?>
        <?php if ($page < $total_pages): ?>
            <a class="page-link" href="?page=<?php echo $page+1; ?>&<?php echo $qs; ?>">Suivant â†’</a>
        <?php endif; ?>
    </div>
    <?php endif; ?>
